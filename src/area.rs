    ...
    T: num_traits::Float,
{
    ...
    pub fn from_square_metres(square_metres: T) -> Self {
        Self::from_square_meters(square_metres)
    }

    /// Create new area from floating point value in Square Nanometers
    pub fn from_square_nanometers(square_nanometers: T) -> Self {
    ...
    pub fn from_square_nanometres(square_nanometres: T) -> Self {
        Self::from_square_nanometers(square_nanometres)
    }

    /// Create new area from floating point value in Square Micrometers
    pub fn from_square_micrometers(square_micrometers: T) -> Self {
        Self::from_square_meters(
            square_micrometers
    ...
    pub fn from_square_micrometres(square_micrometres: T) -> Self {
        Self::from_square_micrometers(square_micrometres)
    }

    /// Create new area from floating point value in Square Millimeters
    pub fn from_square_millimeters(square_millimeters: T) -> Self {
        Self::from_square_meters(
            square_millimeters
    ...
    pub fn from_square_millimetres(square_millimetres: T) -> Self {
        Self::from_square_millimeters(square_millimetres)
    }

    /// Create new area from floating point value in Square Centimeters
    pub fn from_square_centimeters(square_centimeters: T) -> Self {
        Self::from_square_meters(
            square_centimeters
    ...
    pub fn from_square_centimetres(square_centimetres: T) -> Self {
        Self::from_square_centimeters(square_centimetres)
    }

    /// Create new area from floating point value in Square Decimeters
    pub fn from_square_decimeters(square_decimeters: T) -> Self {
        Self::from_square_meters(
    ...
    pub fn from_square_decimetres(square_decimetres: T) -> Self {
        Self::from_square_decimeters(square_decimetres)
    }

    /// Create new area from floating point value in Square Hectometers
    pub fn from_square_hectometers(square_hectometers: T) -> Self {
        Self::from_square_meters(
            square_hectometers
    ...
    pub fn from_square_hectometres(square_hectometres: T) -> Self {
    ...
    pub fn from_square_kilometers(square_kilometers: T) -> Self {
        Self::from_square_meters(
    ...
    pub fn from_square_feet(square_feet: T) -> Self {
        Self::from_square_meters(
    ...
    pub fn from_square_yards(square_yards: T) -> Self {
        Self::from_square_meters(
    ...
    pub fn from_square_miles(square_miles: T) -> Self {
        Self::from_square_meters(
    ...
    pub fn as_square_nanometers(&self) -> T {
        ...
        if let Some(caps) = re.captures(val) {
            ...
            return Ok(
                match caps.get(2).unwrap().as_str().trim().to_lowercase().as_str() {
                    "nm\u{00B2}" | "nm2" => Area::from_square_nanometers(float_val.parse::<T>()?),
                    "\u{00B5}m\u{00B2}" | "\u{00B5}m2" | "um\u{00B2}" | "um2" => {
                        Area::from_square_micrometers(float_val.parse::<T>()?)
                    }
                    "mm\u{00B2}" | "mm2" => Area::from_square_millimeters(float_val.parse::<T>()?),
                    "cm\u{00B2}" | "cm2" => Area::from_square_centimeters(float_val.parse::<T>()?),
                    "dm\u{00B2}" | "dm2" => Area::from_square_decimeters(float_val.parse::<T>()?),
                    "m\u{00B2}" | "m2" => Area::from_square_meters(float_val.parse::<T>()?),
                    "km\u{00B2}" | "km2" => Area::from_square_kilometers(float_val.parse::<T>()?),
                    "ha" | "hm\u{00B2}" | "hm2" => Area::from_hectares(float_val.parse::<T>()?),
                    "acre" | "ac" => Area::from_acres(float_val.parse::<T>()?),
                    "ft\u{00B2}" | "ft2" | "sq ft" => {
                        Area::from_square_feet(float_val.parse::<T>()?)
                    }
                    "yd\u{00B2}" | "yd2" | "sq yd" => {
                        Area::from_square_yards(float_val.parse::<T>()?)
                    }
                    "mi\u{00B2}" | "mi2" | "sq mi" => {
                        Area::from_square_miles(float_val.parse::<T>()?)
                    }
                    _ => Area::from_square_meters(val.parse::<T>()?),
                },
            );
        }

        Ok(Area::from_square_meters(val.parse::<T>()?))
    }
}

implement_measurement! { Area<T> }
