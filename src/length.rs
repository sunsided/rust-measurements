    ...
    T: num_traits::Float,
{
    ...
    pub fn from_furlongs(furlongs: T) -> Self {
...
impl<T> Measurement<T> for Length<T>
where
    T: num_traits::Float,
{
...
implement_measurement! { Length<T> }
